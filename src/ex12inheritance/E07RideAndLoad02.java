...
public class E07RideAndLoad02 {
  ...
  public static void main(String[] args) {
    ...
    /*
    static(정적메서드)는 클래스명을 통해 호출한다 static의 기본규칙을 따르고
    오버라이딩의 대상이 될 수 없다. 인스턴스 내부가 아닌 외부(Method영역)에
    이미 로드되어 있은 상태이기 떄문이다. 
     */
     ...
     */
    // parent.study(); //자식쪽 멤버에 접근불가
    parent.walk();
    // parent.walk(20); //자식쪽 멤버에 접근불가
