...
public class E12MyFriendSerializable {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 프로그램을 시작하면 obj파일에 있는 내용을 복원(역질렬화)해서 List에
         * 추가한다.
         */
...
class FriendInfoHandler {
    ...
    public void readFriendInfo() {
        try {
            ...
            while (true) {
                /*
                 * 직렬화될 때 object 기반으로 저장되므로 반드시 다운캐스팅
                 * 해야한다.
                 */
