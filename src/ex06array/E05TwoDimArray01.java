...
public class E05TwoDimArray01 {
  ...
  public static void main(String[] args) {
    ...
    /*
    아래와 같이 2차원 배열을 초기화하면 세로크기가 3이고 가로크기가 4인 배열이 생성된다. 
    ...
    /*
    2차원 배열에서 "배열명.length"를 통해 전체 행의 크기를 확인
    할수있다
    */
    ...
    for(int i=0 ; i<arr.length ; i++) {
      //2차원 배열에서 각 행의 크기를 배열명[인덱스]를 사용한다.
    ...
    또한 값이 없는 원소, 즉 null로 채워져있는 부분을 출력하면 에외가 발생된다.
    배열의 인덱스를 초과했다는 에러가 발생하면서 실행이 중단된다.
     */
