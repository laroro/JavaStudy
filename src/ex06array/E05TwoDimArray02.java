...
public class E05TwoDimArray02 {
  ...
  public static void main(String[] args) {
    ...
    배열명[인덱스].length : 1차원 배열의 열 크기를 반환한다.
     */
    ...
    출력용 메서드를 정의한 후 필요할떄마다 호출해서 사용한다.
     */
    showArray(twoArray);

    //배열의 참조값과 정수를 전달하여 값을 증가시킨다.
    towDimplus(twoArray, 10);
  ...
  이를 위해 복합대입연산자를 사용하고있다.
   */
  static void towDimplus(int[][] arr2, int plusNum) {
      for(int i=0 ; i<arr2.length ; i++) {
        for(int j=0 ; j<arr2[i].length ; j++) {
