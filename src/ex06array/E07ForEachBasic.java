...
/*
foreach문(개선된 for문)
  : 배열의 일부가 아니라 전체를 참조해야할 때 주로 사용한다
...
public class E07ForEachBasic {
  ...
  public static void main(String[] args) {
    ...
    int[] arr = {1, 2, 3, 4, 5};
    int sum = 0;
    //일반 for문을 통해 index로 접근 후 요소의 합을계산
    ...
    /*
    배열 arr의 요소를 순서대로 하나씩 참조하여 출력하고, 더이상 참조할 요소가 없을 때 for문이 자동으로 종료된다.
     */
    sum = 0;
    for (int e : arr) {
      System.out.print(e + " ");
    ...
    //2차원 배열에서 하나의 행씩 접근해서 1차원배열을 꺼내온다.
    for(int[] a : twoDim) {
