...
public class E05Date {
  ...
  public static String myDateFormat(Calendar c, String formatStr) {
    ...
    getTime() : 서버의 표준시인 1970-01-01 부터 현재까지의
        시간을 초 단위로 반환해준다. 이를 '타임스탬프'라고 부른다.
     */
    Date date = c.getTime();
  ...
  public static void main(String[] args) {
    ...
    //그외 여러가지 서식문자가 존재한다
    String nowStr2= myDateFormat(calendar, "오늘은 M월에 W번째주, d번째날, F번째 E요일");
    ...
    String nowStr3 = myDateFormat(calendar, "yyyy년MM월dd일");
...
//      System.out.println(formatToday+ " "+ formatFuture);
      ...
      즉 100으로 나눠서 뒤에 3자리를 제거하면 순수한 '초'가된다.
