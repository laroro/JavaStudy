...
class MyClass {
  ...
  toString() : 인스턴스가 가진 데이터를 String으로 반환해준다,
    print()가 호출될떄 자동으로 호출되어 출력에 도움을 준다.
   */
  @Override
  ...
  */
  ...
  public boolean equals(Object obj) {
    ...
    이떄 전달된 인스턴스가 McClass타입이 아니라면 비교의 대상이
    될수 없으므로 상속관계 확인을 위해 instanceof 연산자를 사용한다.
     */
...
public class E04Object3Equals {
  public static void main(String[] args) {
    ...
    System.out.println("[두 객체를 equals()메서드를 통해 비교]");
