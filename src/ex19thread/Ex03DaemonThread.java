...
: 하나의 인스턴스가 작업을 완료해야 다음 인스턴스가 작업을 진행할 수 있다.
즉 동시에 작업을 진행할 수 없고, 순차적으로 진행된다.
 */
class NormalClass {
    String title;
...
class NormalThread extends Thread {
    ...
    /*
     * Thread클래스의 생성자 호출시 전달하는 인수를 통해 해당 쓰레드의
     * 이름을 지정할 수 있다. 이 때 지정한 이름은 getName()을 통해
     * 반환할 수 있다.
     */
    ...
    /*
     * 쓰레드 동작중 비정상적으로 종료될 떄 InterruptedException이
...
public class Ex03DaemonThread {
    ...
    public static void main(String[] args) {
         ...
         * JVM이 자동으로 이름을 부여한다. 우선순위를 10으로 지정한다.
         */
        ...
        /*
         * Thread 클래스이 정적메서드를 통해 쓰레드의 여러상태를 확인할 수 있다.
         */
        System.out.println("현재 활성화된 쓰레드 수: " + Thread.activeCount());
