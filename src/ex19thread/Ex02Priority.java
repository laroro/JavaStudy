...
class MessageSendingThread extends Thread {
    ...
    public void run() {
        /*
         * 각 쓰레드는 1000번씩 반복출력한다. 이 떄 부여받은 우선순위를
         * 출력한다.
         */
        for (int i = 0; i <= 1000; i++) {
            ...
            /*
             * 기본적으로 우선순위가 높은 쓰레드가 먼저 실행되지만 sleep()을
             * 호출하면 실행중 잠깐씩 블럭상태로 전환되어 우선순위가 낮은 쓰레드도
             * 실행될 수 있다.
             */
            try {
                sleep(1);
...
public class Ex02Priority {
    ...
    public static void main(String[] args) {
        /*
         * 1단계실행
         * : 우선순위를 부여하지 않은 상태로 쓰레드를 인스턴스를 생성하면
         * 동일한 우선순위 5를 부여받게 된다. 이 떄는 CPU가 알아서 작업을
         * 분배한다.
         */
