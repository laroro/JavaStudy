...
class Sum {
    ...
    /*
     * 메서드 호출시 전다로디는 인수의 값을 누적해서 멤버변수에 더한다.
 ...
 * 상속해야한다면 Runnable인터페이스를 구현해서 쓰레드 클래스를
 * 정의해야한다.
 */
class AdderThread extends Sum implements Runnable {
    ...
    /*
     * 멤버변수 start에서 end까지 반복하면서 부모클래스에 정의된 addNum()을
     * 호출하여 누적합을 계산한다. start가 1이고 end가 10이라면 1~10까지의
     * 합을 쓰레드를 통해 계산하게 된다.
     */
    @Override
    public void run() {
