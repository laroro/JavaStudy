...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		연산결과고 정수가 반환된다. 만약 실수의 결과를 반환받고 싶다면
		...
		아래 정수를 메모리에 로드하는 순간 에러를 발생한다.
		이때 접미사(L 혹은 l)을 붙여서 int형 자료가 아닌 long형의 자료임을
