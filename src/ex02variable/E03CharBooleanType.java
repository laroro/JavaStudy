...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
			...
			/*
			char형 : 하나의 문자를 지정할 수 있는 자료형으로 값을 저장할떄
...
//			char chStr = '가나다라'; 
			...
			/*
			아스키코드 : 1byte로 표현할 수 있는 문자로 영문, 숫자를 십진수로 정의한
				것을 말한다.
				Ex) A => 65, a => 97로 표현된다.
			유니코드 : 1byte로 표현할 수 없는 문자로 영문과 숫자를 제외한 모든
				문자(한글, 한자 등)를 2byte로 표현한다. 보통 숫자가 크기때문에
				16진수로 표현한다.
			 */
			//메모리에 65로 저장된다.
			char ch2 = 'A';
			...
			//싱글쿼테이션으로 감쌋으므르 문자1(아스키코드49)이 할당된다.
			char ch4 = '1';
			...
			boolean타입 : true 혹은 false 두가지의 값만 가질 수 있는 자료형으로
				산술연산(+,-), 비교연산(<, >=)에서는 사용 할 수 없고 논리연산에서만
				사용할 수 있다.
			 */
